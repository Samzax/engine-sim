...
if (ENGINE_SIM_CUDA)
    install(FILES "${PROJECT_SOURCE_DIR}/docs/gpu-backend.md" DESTINATION .)
    install(FILES "${PROJECT_SOURCE_DIR}/tools/launch-gpu.cmd"
        "${PROJECT_SOURCE_DIR}/tools/launch-cpu.cmd" DESTINATION .)
    get_filename_component(_cuda_bin "${CMAKE_CUDA_COMPILER}" DIRECTORY)
    install(FILES "${_cuda_bin}/../EULA.txt" DESTINATION licenses RENAME CUDA-EULA.txt)
    install(FILES ${_cuda_runtime} DESTINATION .)
endif()
...
if (ENGINE_SIM_CUDA)
    set(CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_FILE_NAME}-cuda")
endif()
